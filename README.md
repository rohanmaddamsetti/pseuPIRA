...
MacOS and Linux binaries for `themisto` are provided in the `bin/` directory.  
A Linux binary for `minimap2` is provided in the `bin/` directory.  
However, you may want to install them from github here:
