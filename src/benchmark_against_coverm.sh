...
echo "\ncoverm for comparison\n"
## run coverm for comparison
/usr/bin/time -l -h -p coverm genome --paired ../data/PRJNA280982/SRR1974308_1.fastq ../data/PRJNA280982/SRR1974308_2.fastq --genome-fasta-files ../data/PRJNA280982/chromosome01.fna ../data/PRJNA280982/plasmid02.fna -t 4 -m mean relative_abundance covered_fraction -o ../results/output_coverm.tsv
